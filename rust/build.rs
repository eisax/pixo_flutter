...
fn main() {
    ...
    // In some embedded or relocated setups (like when this crate is vendored
    // under another project), the `docs/` directory may not be present. In
    // that case, skip the docs processing step instead of panicking.
